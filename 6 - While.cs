...
namespace While
{
    ...
    class While
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Comando de repetição while para imprimir na tela a frase com o valor da variável k até que a condição de próxima iteração seja falsa, nesse caso, quando k for igual a 100
            while (k < 100)
            {

...
namespace ExercicioFixacao11
{
    ...
    class ExercicioFixacao11
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                //Imprime a frase na tela com o valor da variável numero e utilizando o método ToString(CultureInfo.InvariantCulture) para fixar o ponto separador da parte inteira da parte decimal do número e com a quebra de linha
